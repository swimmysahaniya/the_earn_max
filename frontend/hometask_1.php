...
$query = "SELECT
    ...
    INNER JOIN myapp_payment AS p ON ct.user_mobile = p.user_mobile
...
<script>
        ...
        videoUrls.forEach((videoUrl, i) => {
            ...
            videoDiv.innerHTML = `
                <div class="video-wrapper">
                    <video id="video${i}" width="100%" style="height: 228px;" controls>
    ...
    function trackVideoPlay(index, taskId) {
